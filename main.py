def main():
    ...
    choice = st.radio("Choose operation:", ("XAML Processor", "Sonar Issues Processor", "Regex Text Pattern Remover","SQL Formatter for Build Generated Scripts"))
    ...
    if choice == "XAML Processor":
        ...
        if __name__ == "__main__":
            main()
    elif choice == "SQL Formatter for Build Generated Scripts":
        important_comments = [
        ...
        if st.button("Beautify SQL"):
            if sql_code.strip() == "":
                ...
                st.info("You can see the Raw Text below:")
